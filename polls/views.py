...
class Index(generic.ListView):
    ...
    # object_list по умолчанию, если указываем то, что ниже, то в HTML будет использоваться это
    context_object_name = 'questions'

    # Тут можно методы переписывать
...
class QuestionDetail(generic.DetailView):
    model = Question
    # По умолчанию _detail, но можем переименовать сами
    # Если не указать, то он будет искать ее в папке с таким же названием (polls) внутри этой папки или внутри templates
    # template_name = ''
